  ...
  return (
    <div className="sk-card p-6">
      <div className="flex items-center justify-between mb-5">
        <h3 className="sk-card-title">Monthly Revenue</h3>
        <SKLabel component="StableCounter" paradigm="spatial" />
      </div>

      <div className="flex items-baseline gap-3">
        <span className="text-display font-semibold tabular-nums tracking-[-0.04em] text-card-foreground">
          {enabled ? (
        ...
        <span className="sk-change text-body-sm font-semibold tabular-nums" data-sentiment={isPositive ? "positive" : "negative"}>
          {enabled ? (
      ...
      <p className="mt-1.5 sk-caption">vs last month</p>
